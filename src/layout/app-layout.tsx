...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['account-owner', 'trader', 'analyst', 'portfolio-manager'];
  ...
  const { data, error, isLoading } = useSWR<ExchangeInterface[]>(
    ...
    () => getExchanges({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Portfolio', path: '/portfolios', entity: 'portfolio', service: AccessServiceEnum.PROJECT, icon: FiFolder },
    {
    ...
    { name: 'Stock', path: '/stocks', entity: 'stock', service: AccessServiceEnum.PROJECT, icon: FiBarChart },
    { name: 'Trade', path: '/trades', entity: 'trade', service: AccessServiceEnum.PROJECT, icon: FiRepeat },
