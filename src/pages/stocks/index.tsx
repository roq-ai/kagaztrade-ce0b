...
function StockListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<StockInterface[]>(
    ...
    () =>
      getStocks({
        relations: ['exchange', 'portfolio_stock.count', 'trade.count'],
      }),
  );
              ...
              <Thead>
                <Tr>
                  ...
                  {hasAccess('portfolio_stock', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>portfolio_stock</Th>
                  )}
                  {hasAccess('trade', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>trade</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
